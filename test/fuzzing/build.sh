...
CMAKEFLAGSALL="$root -GNinja -DCMAKE_BUILD_TYPE=Debug -DLAWS3_LAWS3_FMT_DOC=Off -DLAWS3_LAWS3_FMT_TEST=Off -DLAWS3_LAWS3_FMT_FUZZ=On -DCMAKE_CXX_STANDARD=17"
...
CXX="ccache g++" CXXFLAGS="$CXXFLAGSALL -g" cmake \
  $CMAKEFLAGSALL \
  -DLAWS3_LAWS3_FMT_FUZZ_LINKMAIN=On \
...
CXX=$CLANG \
  ...
  cmake $CMAKEFLAGSALL \
  -DLAWS3_LAWS3_FMT_FUZZ_LINKMAIN=Off \
  -DLAWS3_LAWS3_FMT_FUZZ_LDFLAGS="-fsanitize=fuzzer"
