...
namespace fmt {
template <> struct formatter<lll::abstract> : ostream_formatter {};
}  // namespace fmt
}  // namespace lll

void format_abstract_compiles(const lll::abstract& a) {
...
auto operator<<(std::ostream& os,
                streamable_and_unformattable) -> std::ostream& {
  return os << "foo";
}
