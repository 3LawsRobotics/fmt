...
def build_docs(version="dev", **kwargs):
    ...
    out, _ = p.communicate(
      ...
      GENERATE_RTF      = NO
      CASE_SENSE_NAMES  = NO
      INPUT             = {0}/args.hpp {0}/base.hpp {0}/chrono.hpp {0}/color.hpp \
                          {0}/core.h {0}/compile.hpp {0}/format.hpp {0}/os.hpp \
                          {0}/ostream.hpp {0}/printf.hpp {0}/ranges.hpp {0}/xchar.hpp
      QUIET             = YES
    ...
    internal_symbols = ["fmt::detail::.*", "basic_data<>", "fmt::type_identity"]
    noisy_warnings = [
